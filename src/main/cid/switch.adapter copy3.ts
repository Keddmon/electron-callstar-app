...
//   };
//   // [수정] nbytes 대신 Buffer를 직접 받도록 타입을 수정합니다。
//   private handler?: (packet: Buffer) => void;
...
//       // [수정] handler가 packet 버퍼를 직접 인자로 받도록 수정합니다。
//       this.handler = (packet: Buffer) => {
//         try {
//           // 인자로 받은 packet을 직접 문자열로 변환합니다。
//           const raw = packet.toString('utf8');
